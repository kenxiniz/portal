...
import type {
  Property,
  PropertyTaxResult,
  TaxResult as ComprehensiveTaxResult,
} from "@/lib/tax";
                ...
                <CollapsibleTrigger className="w-full text-left">
                  ...
                  <p className="text-sm text-muted-foreground mb-1 text-center">
                    ...
                    <span className="font-semibold text-foreground">
                      {propertyTaxInfo?.totalPayableAmount.toLocaleString()} 원
                    </span>
                  </p>
                  ...
                  {propertyTaxInfo?.referenceAmount && (
                    <p className="text-xs text-yellow-600 dark:text-yellow-400 mb-2 text-center">
                      (임대사업 아닐 시:{" "}
                      {propertyTaxInfo.referenceAmount.toLocaleString()} 원)
                    </p>
                  )}
              ...
              <Collapsible className="w-full flex flex-col p-4 rounded-lg bg-background">
                <CollapsibleTrigger className="w-full text-left">
                  ...
                  <p className="text-sm text-muted-foreground mb-1 text-center">
                    총 납부액:{" "}
                    <span className="font-semibold text-foreground">
                      {comprehensiveTaxInfo?.taxAmount.toLocaleString()} 원
                    </span>
                  </p>
