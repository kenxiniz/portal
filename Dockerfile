...
RUN echo "--- Dockerfile Build-Time Arguments ---"
RUN echo "NEXT_PUBLIC_KAKAO_CLIENT_ID: ${NEXT_PUBLIC_KAKAO_CLIENT_ID}"
RUN echo "NEXT_PUBLIC_KAKAO_REDIRECT_URI: ${NEXT_PUBLIC_KAKAO_REDIRECT_URI}"
RUN echo "---------------------------------------"
